...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI, KC_LALT, MO(1), KC_SPC, KC_ESC,    KC_BSPC, KC_ENT, MO(2), MO(3), KC_LEFT, KC_DOWN, KC_RGHT
    ),

    [_RAISE] = LAYOUT(
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                   KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                   KC_MINS, KC_EQL, KC_LBRC, KC_RBRC, KC_NO, KC_NO, KC_NO,
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                   KC_NO, KC_QUOT, KC_BSLS, KC_NO, KC_NO, KC_NO, KC_NO,
